...
""")
        ...
        if dineroap > dinero:
            ...
            if opcionbj == 1 and not cartasbj > 21:
                ...
                print(f"\nquedaste con {cartasbj}")
        
        if cartasbj == 0:
            reiniciar = 1
        elif cartasbj > cartasbj2:
           if cartasbj <= 21:
              ganastebj = 1
           elif cartasbj > 21:
              perdistebj = 1
        elif cartasbj == cartasbj2 and cartasbj <= 21:
            empatebj = 1
        elif cartasbj < cartasbj2:
            if cartasbj2 > 21:
               ganastebj = 1
        ...
        if empatebj == 1:
            print("\nquedaste en empate! el dinero se regresa!")
        if reinciar == 1:
            print("\npor error de sistema se va a reinciar blackjack, no se perdera dinero")
        if perdistebj == 1:
           dinero -= dineroap
